	...
	*/
	...
	function extra_tablenav( $which ) {
		if ( $which == "top" ){	
			...
			echo " <a class='button-primary action alignright' onclick='return confirm_delete(\"#delete_all_scheduled_entries\", \"" . __('Are you sure?', 'bookyourtravel') . "\");' href='edit.php?post_type=cruise&page=theme_cruise_schedule_admin.php&action=delete_all_scheduled_entries'>Delete all scheduled entries</a>";
			echo '</p>';
			echo '</div>';
		}
		if ( $which == "bottom" ){
