...
?>
	<div class="form-field">
		...
		<select id="term_meta[tour_type_is_repeated]" name="term_meta[tour_type_is_repeated]" onchange="is_tour_type_repeated_changed('block')">
...
function bookyourtravel_tour_type_edit_meta_fields($term) {
	...
	<tr class="form-field">
		...
		<td>
			<select id="term_meta[tour_type_is_repeated]" name="term_meta[tour_type_is_repeated]" onchange="is_tour_type_repeated_changed('table-row')">
...
?>
	<div class="form-field">
		...
		<select id="term_meta[cruise_type_is_repeated]" name="term_meta[cruise_type_is_repeated]" onchange="is_cruise_type_repeated_changed('block')">
			<option value="0"><?php _e('No', 'bookyourtravel') ?></option>
			<option value="1"><?php _e('Daily', 'bookyourtravel') ?></option>
			<option value="2"><?php _e('Weekdays', 'bookyourtravel') ?></option>
			<option value="3"><?php _e('Weekly', 'bookyourtravel') ?></option>
...
function bookyourtravel_cruise_type_edit_meta_fields($term) {
	...
	<tr class="form-field">
		...
		<td>
			<select id="term_meta[cruise_type_is_repeated]" name="term_meta[cruise_type_is_repeated]" onchange="is_cruise_type_repeated_changed('table-row')">
