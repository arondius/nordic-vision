...
$theme_metaboxes = array(
		"thumb-small" => array (
			...
			"type" 		=> "text",
			"desc"      => "Upload your image with 'Add Media' above post window, copy the url and paste it here. Width should be: 390 pixels"
		),
		"thumb-large" => array (
			"name"		=> "thumb-large",
			"default" 	=> "",
			...
			"type" 		=> "text",
			"desc"      => "Upload your image with 'Add Media' above post window, copy the url and paste it here. Width should be: 960 pixels"
		),
	);
